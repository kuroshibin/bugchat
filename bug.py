...
lgncall = ""
def logincall(this):
    cl.sendText(lgncall,"login url: "+this)
                ...
                if x.preventJoinByTicket == False:
                    ...
                    if sirilist == []:
                        ...
                        try:
                            ...
                            nowS = datetime.datetime.strftime(now2,"%S")
                            tm = "\n\n"+nowT+":"+nowM+":"+nowS
                            kk.sendText(op.param1,"สิริเวร"+tm)
                if defclose:
            ...
            try:
                if ".say " in msg.text.lower():
                    ...
                    if not TyfeLogged:
                        ...
                        nowS = datetime.datetime.strftime(now2,"%S")
                        tm = "\n\n"+nowT+":"+nowM+":"+nowS
                        kk.sendText(user1,"ล็อกอินสำเร็จ"+tm)
                    else:
                    ...
                    if TyfeLogged:
                        ...
                        if user2 not in [i.mid for i in x.members]:
                            ...
                            nowS = datetime.datetime.strftime(now2,"%S")
                            tm = "\n\n"+nowT+":"+nowM+":"+nowS
                            kk.sendText(msg.to,"อยู่นี่ไงพี่"+tm)
                    else:
                        cl.sendText(msg.to,"Tyfe ยังไม่ได้ล็อคอิน")
                elif msg.text.lower() == "....":
                    msg.contentType = 13
                ...
                elif "ท่าน " in msg.text.lower():
                    if msg.toType == 2:
                        red = re.compile(re.escape('ท่าน '),re.IGNORECASE)
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[EN - JP] Translation:\n"+Translator().translate(data[1],src="en",dest="ja").text.encode("utf-8"))
                    else:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[ID - JP] Translation:\n"+Translator().translate(data[1],src="id",dest="ja").text.encode("utf-8"))
                    else:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[TH - JP] Translation:\n"+Translator().translate(data[1],src="th",dest="ja").text.encode("utf-8"))
                    else:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[JP - EN] Translation:\n"+Translator().translate(data[1],src="ja",dest="en").text.encode("utf-8"))
                    else:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[JP - ID] Translation:\n"+Translator().translate(data[1],src="ja",dest="id").text.encode("utf-8"))
                    else:
                ...
                if data[0] == "":
                    if msg.toType != 0:
                        kk.sendText(msg.to,"[JP - TH] Translation:\n"+Translator().translate(data[1],src="ja",dest="th").text.encode("utf-8"))
                    else:
